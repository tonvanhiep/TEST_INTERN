    ...
    <table class="table table-hover table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td data-th="Name">
                    <input style="min-width: fit-content" class="form-control inp-row-{{ $item->admin_id }} inp-name" value="{{ $item->name }}" name="name" disabled>
                </td>

                <td class="actions" data-th="Email">
                    <input style="min-width: fit-content" class="form-control inp-row-{{ $item->admin_id }} inp-email" value="{{ $item->email }}" name="email" disabled>
                </td>

                <td class="actions" data-th="Group">
                    <select style="min-width: fit-content" class="form-select inp-row-{{ $item->admin_id }} inp-status" name="status" aria-label="Disabled select example" disabled>

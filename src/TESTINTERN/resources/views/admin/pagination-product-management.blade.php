        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions" data-th="Edit">
                    <button class="btn btn-outline-success" id="btn-edit-inp-{{ $item->product_id }}"
                        onclick="displayProductId('{{ route('admin.product.p_edit') }}', {{ $item->product_id }});">詳細
                    </button>
                </td>

                <td class="actions" data-th="Remove">
                    <button class="btn btn-outline-danger" id="btn-edit-inp-{{ $item->product_id }}"
                        onclick="deleteProductId({{ $item->product_id }});">削除
                    </button>
                </td>
            </tr>
            @endforeach
